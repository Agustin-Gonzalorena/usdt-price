  ...
  try {
    ...
    array.push(
      ...
      },
      {
        ...
        dif: (
          ((data.fiwind.totalAsk - data.fiwind.totalBid) /
            data.fiwind.totalBid) *
          100
        ).toFixed(2),
      },
      {
      ...
      },
      {
        ...
        dif: (
          ((data.trubit.totalAsk - data.trubit.totalBid) /
            data.trubit.totalBid) *
          100
        ).toFixed(2),
      },
      {
        ...
        dif: (
          ((data.eluter.totalAsk - data.eluter.totalBid) /
            data.eluter.totalBid) *
          100
        ).toFixed(2),
      },
      {
